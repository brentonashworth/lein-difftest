...
If you would like to see a quick example of what test failures look like with this plugin, or if you would like to experiment with and improve it, enter the following commands:
...
All of the tests fail so that you can see examples of exceptions, and diffs.

h2. Leiningen Usage

Add <code>[lein-difftest "1.2.1"]</code> to your project's :dev-dependencies.
